...
export function EmployeeNotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="Employee workspace" title="Notifications" description="Review assignment updates, leave decisions, and team reminders in one place." />

      <SectionPanel title="My alerts">
